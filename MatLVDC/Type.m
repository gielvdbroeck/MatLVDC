...
classdef Type
    %TYPE Class that defines the component types
    %   A component is either a voltage output or a current output
    %   component
    %
    ...
    enumeration
        % Voltage output (VO) component
        VO;
        % Current output (CO) component
        CO;
    end
end
